...
public class Player : Moving
{
    ...
    protected override void ReceiveDamage(Damage dmg)
    {
        ...
        dmg.damageAmount = dmg.damageAmount - (playerStats.armorModifier.GetValue() * playerStats.armor.GetValue());
        dmg.damageAmount = Mathf.Clamp(dmg.damageAmount, 0f, int.MaxValue);
